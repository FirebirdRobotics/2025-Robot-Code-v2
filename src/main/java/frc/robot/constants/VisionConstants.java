...
public class VisionConstants {
    ...
    public static final Transform3d kRobotToLeftAprilCam =
            new Transform3d(new Translation3d(-0.2704338,0.1524, 0.2032), new Rotation3d(0, 0.0169839228695, 2.0311495329798+Units.degreesToRadians(90)));
    ...
    public static final Transform3d kRobotToRightAprilCam =
            new Transform3d(new Translation3d(-0.2704338,0.1016, 0.2032), new Rotation3d(0, 0.0169839228695, 1.071218444385+Units.degreesToRadians(90)));
    // Cam mounted TBD
